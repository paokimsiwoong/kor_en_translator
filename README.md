...
│   ├── models/ <br>
│   │   └── ko_en_transformer.pt # 학습된 PyTorch 모델 가중치 <br>
│   ├── tests/ <br>
│   │   ├── \_\_init__.py <br>
│   │   └── test_translate.py    # 간단한 API/서빙 테스트 <br>
...
│   └── package.json                  # 프론트엔드 의존성 + 스크립트 <br>
│ <br>
└── README.md <br>
...
3. config.yaml 파일의 MODEL_PATH 필드에 트랜스포머 모델 .pth 파일 위치 입력
