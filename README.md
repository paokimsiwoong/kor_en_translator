...
- **한국어 -> 영어** Transformer 모델 추론 
    ...
    <img width="459" height="407" alt="translate" src="https://github.com/user-attachments/assets/2c8d3129-a29a-458f-bc2c-f5a9d5cf21b0" />
- **Attention 시각화** (Altair 히트맵)
    <img width="417" height="459" alt="visualization" src="https://github.com/user-attachments/assets/347dd741-1b6d-4856-af4a-03682dc42faf" />
- **JWT 인증** (로그인/회원가입)
...
- **배치 번역** 지원 (여러 문장 동시 처리)
    <img width="454" height="457" alt="batch" src="https://github.com/user-attachments/assets/b9654304-c305-4859-ad1c-41f0c5106741" />
